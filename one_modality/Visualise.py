...
def main(args):
    ...
    for patient_num in patient_nums:        
        ...
        ax = sns.heatmap(fl_slice, cbar=False, cmap="Blues", xticklabels=False, yticklabels=False)
        ax.invert_yaxis()
        plt.savefig(args.path_save + str(patient_num) + 'flair.png')
        # plt.clf()

        ax = sns.heatmap(t1_slice, cbar=False, cmap="Reds", xticklabels=False, yticklabels=False, alpha=0.1)
        ax.invert_yaxis()
