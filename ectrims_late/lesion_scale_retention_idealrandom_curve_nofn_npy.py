...
def main(args):
    ...
    for npy_file in npy_files:
        ...
        lesion_types = [np.full(shape=(n,), fill_value=t) 
                         for n,t in zip([n_tp, n_fp], ['tp', 'fp'])]
