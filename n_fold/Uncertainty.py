...
def ensemble_uncertainties_classification(probs, epsilon=1e-10):
    ...
    reoe = renyi_entropy_of_expected(probs, epsilon)
    rexe = renyi_expected_entropy(probs, epsilon)

    renyi_mutual_info = reoe - rexe
    ...
    uncertainty = {'confidence': -1 * conf,
                   ...
                   'renyi_entropy_of_expected': reoe,
                   'renyi_expected_entropy': rexe,
                   'renyi_mutual_information': renyi_mutual_info,
                   }
